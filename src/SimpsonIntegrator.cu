...
//
float
SimpsonIntegrator::distance (TimeSeries &ts1, TimeSeries &ts2, int ts_length)
{
...
void
SimpsonIntegrator::match_naive (TimeSeries &ts, TimeSeriesCollection &tsc)
{
...
// Optimized version.
void
SimpsonIntegrator::match (TimeSeries &ts, TimeSeriesCollection &tsc)
{
