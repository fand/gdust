...
double Euclidean::dtw( TimeSeries &ts1, TimeSeries &ts2 )
{
    int len1 = ts1.length();
    int len2 = ts2.length();
...
void Euclidean::calcCost( TimeSeries &ts1, TimeSeries &ts2, double *table_d, double *table_g, int len1, int len2 )
{
